package com.aiways.seata.goods.config;


import com.aiways.seata.goods.config.properties.CORSProperties;
...
//        config.addAllowedOrigin("http://manage.leyou.com");
        //隐式传参
        this.props.getAllowedOrigins().forEach(config::addAllowedOrigin);
